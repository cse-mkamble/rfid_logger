module.exports = updateSchoolAuthMail = (name, url, CONTACT_US, date) => {
    return `
        <div>
                ...
                <div style=" padding: 20px 5px; ">
                    <div>
                        ...
                        <div>
                            ...
                            <h3>${name},</h3>
                            <br />
                            Someone (hopefully you) has requested a Update Details for your <strong>School
                                Software</strong> account.
                            <br>
